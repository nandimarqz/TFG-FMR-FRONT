...
import './css/Card.css';
import studentscsv from '../data/Alumnos.csv'
...
export default function UploadStudentCard() {
    ...
    function uploadFile(){
        if(csv !== ''){
            axios({
                method: 'POST',
                url: "/back/public/api/uploadStudentCSV",
                headers: {
    ...
    return (
          ...
          <div className="card mt-5 mx-auto" style={{ width: '50rem' }}>
            <div className="card-header text-white">
                <h4 className="card-title">Carga de Estudiantes CSV </h4>
            </div>
            <p className='text-center mt-2 fw-bold'>CSV de ejemplo.............<a href={studentscsv} download="Alumnos.csv">Alumnos.csv</a></p>
                ...
                <div className="input-group mb-3">
                    ...
                    {fileUploaded === true &&
                        <p className='text-success'>Se han cargado los alumnos satisfactoriamente</p>
                    }
